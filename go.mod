module github.com/Seann-Moser/hypr-config-manager

go 1.25.5

require (
	github.com/Seann-Moser/credentials v0.0.22
	github.com/Seann-Moser/mserve v0.0.28
	github.com/Seann-Moser/rbac v1.0.15
